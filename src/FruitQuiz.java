...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		question1 = new JLabel(
				"<html>Which is not a real animal? <br> A: boxer crab<br> B: Pink Fairy Armadillo <br> C: Dumbo Octopus</html>");
		// 11. Make another question called "question2"
		question2 = new JLabel(
				"<html>Which is not a real meme <br> A:bee movie <br> B: we are numbr one <br> C: pepe the frog</html>");
	}
